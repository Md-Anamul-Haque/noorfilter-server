...
import { ShieldCheck, User, LogOut, CheckCircle2, AlertCircle, Smartphone, Clock, CreditCard, CalendarDays, ArrowRightCircle, Package, Sparkles, Zap, HeartHandshake } from "lucide-react";
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        ...
        {loadingSub ? (
          ...
          <div className="grid lg:grid-cols-12 gap-8">
            ...
            {/* Right Main Content (Pricing/Options) */}
            <div className="lg:col-span-8 space-y-6">
              
              {!hasAccess && subscription && (
                <div className="bg-rose-50 border border-rose-200 text-rose-800 p-5 rounded-2xl flex gap-4 shadow-sm animate-in fade-in slide-in-from-bottom-4 duration-500">
                  <div className="p-2 bg-rose-100 rounded-full h-fit">
                     <AlertCircle className="w-6 h-6 text-rose-600" />
                  </div>
                  <div>
                    <h4 className="font-bold text-lg text-rose-900">Access Expired</h4>
                    <p className="font-medium mt-1 text-rose-700/80">Your subscription or trial period has concluded. Please select an option below to regain full protection.</p>
                  </div>
                </div>
              )}
                  ...
                  <div className="p-7 sm:p-9 relative z-10">
                    ...
                    <div className="bg-amber-50/50 border border-amber-200/60 rounded-2xl p-5 mb-6 flex gap-4 items-start">
                      ...
                      <p className="text-sm text-amber-900/80 font-semibold leading-relaxed">
                        "আমি এই মুহূর্তে সাবস্ক্রিপশনের খরচ বহন করতে পারছি না। আমি ফ্রি অ্যাক্সেসের জন্য আবেদন করতে চাই।"
                      </p>
                    </div>
